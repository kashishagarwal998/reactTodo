...
const TodoCard = ({todo,setTodos,openu,view,theme}) => {
  ...
  if(view=="list"){
    return (
      <div className={`h-[300px] w-[300px] border border-black/10 rounded-lg p-3 ${theme=="light"?"bg-[#FFB4A2]":"bg-black text-white"  }`}>
    ...
    <div className='w-[270px] mt-2 h-[200px] border border-black/10 rounded-lg p-2 bg-[#FFF5E4]'><p className='text-sm break-words'>{description}</p></div>
